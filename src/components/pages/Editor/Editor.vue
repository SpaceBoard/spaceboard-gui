...
<div class="wrapper">
  <div class="canvas-area">
    <div class="canvas-wrapper" ref="canvas-wrapper"  v-touch:pinch="onZoom" v-touch:pinchstart="onZoomStart" v-touch:pinchend="onZoomEnd">
      <div class="canvas-toucher" v-touch:pan="onPanCam" ref="canvas-toucher"></div>
